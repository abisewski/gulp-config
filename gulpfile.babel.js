 ...
 * Task: `compileJS`.
 *
 * Runs the babel compiler and browserify.
 * This function isn't from WPGulp initially.
 */
...
gulp.task(
  ...
  gulp.parallel(
    ...
    () => {
      ...
      gulp.watch(config.watchJsCustom, gulp.series("compileJS", reload)); // Reload on customJS file changes.
